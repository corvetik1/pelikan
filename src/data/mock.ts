...
export const news: NewsArticle[] = [
  {
    ...
    excerpt:
      'Компания «Меридиан» расширяет логистические мощности и открывает новый распределительный центр в Санкт-Петербурге.',
    content: [
      'Компания «Меридиан» официально объявила о запуске нового распределительного центра площадью 10 000 м², который позволит сократить сроки доставки продукции по Северо-Западному региону.',
